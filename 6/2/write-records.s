...
# It is unclear should I write 30 identical records only one user in this 
# file or whole users. I wrote whole user records.
...
.globl _start
	...
	_start:
		...
		mov	$30, %ecx	# Value for our loop

	identical_records:

		push	%ecx		# push it into stack
		...
		pop	%ecx		# pop loop count from stack
		dec	%ecx		# decrease it by one
		cmp	$0, %ecx	# is this the end of our cycle?
		jne	identical_records # if not - repeat
