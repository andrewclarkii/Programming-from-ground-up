...
#          converted to uppercase. Keep file 
#          descriptors in .bss
...
# first step:  as --32 -o toupper-3.o toupper-3.s
# second step: ld -melf_i386 -o toupper-3 toupper-3.o
...
.lcomm	IDESC,	4       # space for input file descriptor
.lcomm	ODESC,	4       # space for output file descriptor
...
### OPEN INPUT FILE ###
	...
	store_fd_in:
		...
		mov	%eax, IDESC		# save the given file descriptor
	open_fd_out:
### OPEN OUTPUT FILE ###
	...
	store_fd_out:
		...
		mov	%eax, ODESC 		# store the file descriptor here
### BEGIN MAIN LOOP ###
	read_loop_begin:
### READ IN A BLOCK FROM THE INPUT FILE ###
		mov	$SYS_READ, %eax			# get the input file descriptor
		mov	IDESC, %ebx		# the location to read into
